            ...
            data.forEach((movies, i) => {
                ...
                $("#moviesOutput").append(`
                    ...
                    ${ /* ========SVG for the delete button================== */'' }
                     <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="deleteButton bi bi-trash" data-id="${data[i].id}" viewBox="0 0 16 16" style="position:absolute; margin-left: 535px; margin-top: 5px; color: white;">
