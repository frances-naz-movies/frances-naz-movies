...
function getMovies(){
    fetch(moviesURL).then(response => response.json().then(data => {
        ...
        function printMovies(data) {
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="deleteButton bi bi-trash" viewBox="0 0 16 16" style="position:absolute; margin-left: 520px; margin-top: 5px">
        ...
        $(".deleteButton").on('click', function () {
            ...
            fetch(moviesURL + "/" + this.id, deleteOptions).then(getMovies);
        })
